...
def main():
    ...
    configs = {
        ...
        # --- 100M scale configs (~110M params, d_embed=512) ---
        "v2_100m_base": lambda: FelixV2Config(
            d_embed=512,
            d_stream=512,
            num_streams=4,
            num_layers=0,
        ...
        "v2_100m_felix": lambda: FelixV2Config(
            d_embed=512,
            d_stream=256,
            d_post=64,
            num_streams=2,
            num_layers=2,
            num_refine_layers=19,
            num_heads=4,
            num_refine_heads=8,
            ffn_mult=4,
            merge_bias_init=1.0,
        ),
        "v2_100m_felix_add": lambda: FelixV2Config(
            d_embed=512,
            d_stream=128,
            d_post=32,
            num_streams=2,
        ...
        "v2_100m_felix_4s": lambda: FelixV2Config(
            d_embed=512,
            d_stream=256,
            d_post=64,
            num_streams=2,
        ...
        "v2_100m_felix_6s": lambda: FelixV2Config(
            d_embed=512,
            d_stream=256,
            d_post=64,
            num_streams=2,
            num_layers=6,
            num_refine_layers=17,
            num_heads=4,
            num_refine_heads=8,
            ffn_mult=4,
            merge_bias_init=1.0,
        ),
        "v2_100m_felix_4str": lambda: FelixV2Config(
            d_embed=512,
            d_stream=256,
            d_post=64,
            num_streams=4,
